...
function withCORS(headers, request) {
    headers['access-control-allow-origin'] = 'http://localhost:8000 https://blooket-utility.herokuapp.com';
...
const createServer = function createServer(options) {
    ...
    proxy.on('error', function proxyErrorHandler(err, req, res) {
        ...
        res.writeHead(404, {'Access-Control-Allow-Origin': 'http://localhost:8000 https://blooket-utility.herokuapp.com'});
